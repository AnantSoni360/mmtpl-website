        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex items-center gap-4">
              <Link href="/coming-soon" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white/70 hover:bg-[#3b82f6] hover:text-white hover:-translate-y-1 transition-all border border-white/10 shadow-sm">
