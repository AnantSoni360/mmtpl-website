...
const directors: Leader[] = [
  ...
  { id: 'd2', name: 'Akheel Ahmed', title: 'Director Operation', department: 'Operations', experience: '22+ Years', responsibilities: ['Operational Excellence', 'Resource Management'], photo: '/images/team/Akheel-Ahmed.jpeg' },
...
const keyPersonnel: Leader[] = [
  { id: 'k2', name: 'Mohmad Raffeq', title: 'Project Manager', department: 'Refractories', experience: '20+ years', responsibilities: ['Project Supervision', 'Material Management'], photo: '/images/team/Mohammad-Rafiq.jpeg' },
